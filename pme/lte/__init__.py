...
_EXPORT_MODULES = {
    ...
    "RayTraceResult": "pme.lte.geometry",
    "chart_to_direction": "pme.lte.geometry",
    "direction_to_chart_mm": "pme.lte.geometry",
    "intersect_sphere_near_side": "pme.lte.geometry",
    "intersect_sphere_near_side_from_local_point": "pme.lte.geometry",
    "project_vectors_to_stokes": "pme.lte.geometry",
